...
#define defaults_h
  ...
  #define DEFAULT_Z_MAX_RATE 4500.0 // mm/min
  ...
  #define DEFAULT_X_MAX_TRAVEL 430.0 // mm
  #define DEFAULT_Y_MAX_TRAVEL 290.0 // mm
  #define DEFAULT_Z_MAX_TRAVEL 70.0 // mm
  ...
  #define DEFAULT_INVERT_ST_ENABLE 1 // false 0?
