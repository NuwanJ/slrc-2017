...
//#define HOMING_CYCLE_1 (1<<Z_AXIS)                // REQUIRED: First move Z to clear workspace. /*Nuwan*/
#define HOMING_CYCLE_0 ((1<<X_AXIS)|(1<<Y_AXIS))  // OPTIONAL: Then move X,Y at the same time.  /*Nuwan*/
...
#define HOMING_SINGLE_AXIS_COMMANDS // Default disabled. Uncomment to enable. /*Nuwan*/

// After homing, Grbl will set by default the entire machine space into negative space, as is typical
// for professional CNC machines, regardless of where the limit switches are located. Uncomment this
// define to force Grbl to always set the machine origin at the homed location despite switch orientation.
#define HOMING_FORCE_SET_ORIGIN // Uncomment to enable. /*Nuwan*/
