...
/* The defaults.h file serves as a central default settings selector for different machine
  ...
  #define DEFAULT_X_MAX_TRAVEL 430.0 // mm NOTE: Must be a positive value.
  ...
  #define DEFAULT_INVERT_ST_ENABLE 0 // false  /*Nuwan*/
...
#ifdef DEFAULTS_BUILDER_V3
  // Defaulr Settings for Builder_V3 (http://crad.ceykod.com/pages/CNC)
  #define DEFAULT_X_STEPS_PER_MM 400.0
  ...
  #define DEFAULT_X_MAX_TRAVEL 430.0 // mm NOTE: Must be a positive value.
  #define DEFAULT_Y_MAX_TRAVEL 290.0 // mm NOTE: Must be a positive value.
  #define DEFAULT_Z_MAX_TRAVEL 70.0 // mm NOTE: Must be a positive value.
  #define DEFAULT_SPINDLE_RPM_MAX 10000.0 // rpm
  ...
  #define DEFAULT_ARC_TOLERANCE 0.002 // mm
  #define DEFAULT_REPORT_INCHES 0 // false
  #define DEFAULT_INVERT_ST_ENABLE 1 // false  /*Nuwan*/
  #define DEFAULT_INVERT_LIMIT_PINS 0 // false
  #define DEFAULT_SOFT_LIMIT_ENABLE 0 // false
  #define DEFAULT_HARD_LIMIT_ENABLE 0  // false
  #define DEFAULT_INVERT_PROBE_PIN 0 // false
